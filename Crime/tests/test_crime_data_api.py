from crime_data_api.crime_data_api import lambda_handler
import sys
import os
import json
import pytest
...
def test_lambda_handler_valid_suburb(monkeypatch, mock_static_response):
    ...
    monkeypatch.setattr("crime_data_api.crime_data_api.table",
...
def test_lambda_handler_exception(monkeypatch):
    ...
    monkeypatch.setattr("crime_data_api.crime_data_api.table", type(
