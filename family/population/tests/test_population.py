...
def test_get_suburb_population_no_csv_data(s3_setup, set_env_vars, monkeypatch):
  """
...
def test_get_suburb_population_no_matching_csv(s3_setup, set_env_vars):
  ...
  """
  # Overwrite the CSV file with data that does not contain the matching SAL code.
  dummy_csv = (
      "SAL_CODE_2021,Tot_P_M,Tot_P_F\n"
      "SAL999,100,200\n"
  )
